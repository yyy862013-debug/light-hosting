...
import { Server, Eye, EyeOff, LogOut, User, ArrowRight, Lock, Mail, AlertCircle, Download, Settings } from "lucide-react";
...
function AuthPage({onLogin}) {
  ...
  return (
    <div style={{minHeight:"100vh",background:"#0a0a0f",display:"flex",alignItems:"center",justifyContent:"center",padding:"16px",position:"relative",overflow:"hidden"}}>
            ...
            {mode==="signup"&&(
              <div>
                ...
                <div style={{position:"relative"}}>
                  ...
                  <input name="username" value={form.username} onChange={handleChange} placeholder="Steve123" style={inp}/>
                </div>
              </div>
            )}
            <div>
              ...
              <div style={{position:"relative"}}>
                ...
                <input name="email" value={form.email} onChange={handleChange} placeholder="you@example.com" type="email" style={inp}/>
              </div>
            </div>
            <div>
              ...
              <div style={{position:"relative"}}>
                ...
                <input name="password" value={form.password} onChange={handleChange} placeholder="••••••••" type={showPass?"text":"password"} style={{...inp,padding:"10px 40px"}}/>
      ...
      <style>{`@keyframes spin{to{transform:rotate(360deg)}} input::placeholder{color:#52525b!important}`}</style>
    </div>
  );
}
...
function Dashboard({username,onLogout}) {
  ...
  const tabs=[{id:"resolver",label:"Download Resolver",icon:Download},{id:"config",label:"Server Config",icon:Settings}];
  return (
    <div style={{minHeight:"100vh",background:"#0a0a0f",fontFamily:"system-ui,-apple-system,sans-serif"}}>
      ...
      <main style={{maxWidth:"900px",margin:"0 auto",padding:"32px 16px",position:"relative"}}>
        <div style={{marginBottom:"28px"}}>
          <h1 style={{fontSize:"20px",fontWeight:700,color:"white",margin:"0 0 4px"}}>Dashboard</h1>
          <p style={{color:"#71717a",fontSize:"14px",margin:0}}>Software logic, auto-installer and server configuration.</p>
        </div>
